// Entry point loaded by the railgrid portal as a single <script> tag.
...
const TAG = 'railgrid-provider-infrastructure'
const TILE_TAG = 'railgrid-dashboard-tile-infrastructure'
